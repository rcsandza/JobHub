  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 modal-backdrop">
        <div className="relative w-full max-w-[600px] mx-4 modal-content">
          {/* Close button */}
          <button
            onClick={onClose}
            className="absolute -top-2 -right-2 p-2 bg-white hover:bg-gray-100 rounded-full transition-colors shadow-lg z-10"
            aria-label="Close"
          >
            <X className="h-5 w-5 text-foreground" />
          </button>

          <div className="bg-white rounded-lg shadow-xl overflow-hidden border border-[#E6E4D6]">
            ...
            <div style={{ padding: '32px 28px 24px' }}>
              <div className="flex flex-col items-end gap-6">
                ...
                <div className="flex flex-col gap-4 w-full">
                  {/* Main success card */}
                  <div className="bg-white rounded-lg border border-[#E6E4D6] flex flex-col items-center gap-4" style={{ padding: '24px 16px' }}>
                  ...
                  <defs>
                    ...
                    <div className="flex flex-col items-center gap-5 w-full">
                      {/* Success message */}
                      <h1
                        className="text-center animate-item-2 w-full"
                        style={{
                      ...
                      {/* Divider */}
                      <div className="animate-item-3" style={{ width: '320px', height: '0px', borderTop: '1.5px solid #F2F2EC' }}></div>

                      {/* Job info container */}
                      <div className="flex flex-row justify-center items-center gap-4 animate-item-4">
                        <div className="flex flex-col justify-center items-center gap-1">
                          {/* Job title - plain text button */}
                          <button
                          ...
                          {/* Company name with chevron - tertiary button */}
                          {companyUrl ? (
                            <a
                              href={companyUrl}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center justify-center gap-2 h-6 hover:opacity-80 transition-opacity"
                              style={{
                                fontFamily: '"Plus Jakarta Sans"',
                                fontSize: '16px',
                                fontWeight: 700,
                            ...
                            <button
                              className="flex items-center justify-center gap-2 h-6"
                              style={{
                                fontFamily: '"Plus Jakarta Sans"',
                                fontSize: '16px',
                                fontWeight: 700,
                  ...
                  {/* Next step card */}
                  <div className="bg-white rounded-lg border border-[#E6E4D6] flex flex-row items-center gap-4 w-full animate-item-6" style={{ padding: '16px 8px 16px 16px' }}>
                    {/* Lightbulb icon */}
